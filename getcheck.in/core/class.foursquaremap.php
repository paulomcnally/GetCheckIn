...
class Foursquaremap {
    ...
    function getCheckins() {
        ...
        try {
			...
			$this->allCheckins = $this->rawData->{"response"}->{"checkins"}->{"items"};
    ...
    public function getMapUrl($width, $height, $zoom = 15, $markerText = ".", $markerColor = "red", $mobile = FALSE, $maptype = "roadmap") {
